function output=modORd_MID(t,X,varargin) 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Gto=0.02*4.; %scale factor from supplementary mat
%
...
GK1=0.1908*2.3238*sqrt((ko)/5.4)*1.3;
%
...
zna=1.0;        Gncx=0.0008*1.4;    zca=2.0;
...
Pnak=30*0.7;  % NOT SURE THIS IS THE CONDUCANCE THAT NEEDS TO BE SCALED FOR M cells
%
...
Jrel_inf=a_rel*(-ICaL)/(1.0+(1.5/cajsr)^8.0)*1.7;
...
Jrel_infp=a_relp*(-ICaL)/(1.0+(1.5/cajsr)^8.0)*1.7;
