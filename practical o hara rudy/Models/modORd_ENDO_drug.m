function output=modORd_ENDO_drug(t,X,varargin) 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
[flag_ode, pstim, CL, cEx d_concentration h_coeffs IC50s]=optargs{:};

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%Drug params
drug_concen = d_concentration;
Kr_h_coeff = h_coeffs(1);
CaL_h_coeff= h_coeffs(2);
Na_h_coeff = h_coeffs(3);
Kr_IC50 = IC50s(1);
CaL_IC50 = IC50s(2);
Na_IC50 = IC50s(3);
...
INa = INa * hill_curve(drug_concen,Na_h_coeff, Na_IC50);
...
ICaL = ICaL * hill_curve(drug_concen,CaL_h_coeff, CaL_IC50);
...
IKr = IKr * hill_curve(drug_concen,Kr_h_coeff, Kr_IC50);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% IKs current
