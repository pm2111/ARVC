...
input_args{1} = 1;
% modify input argsstim_amplitude
%stim_amplitude = 270 -80*i/30;
stim_amplitude = 20;
input_args{2} = [5,stim_amplitude,0.5,100];  %first variable is related to stimulation protocol
input_args{3} = t_sim;
input_args{4} = ramp_steps;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Simulations
...
xlabel('Stimulus Current (microA)');
